------------------------------------------------------------------------------------------------
--
--					DMCapabiliteRetest PARTITIONNING
--
------------------------------------------------------------------------------------------------
...
BEGIN
    ...
    BEGIN
        ...
        SET @f += 1
        SET @sql = 'ALTER DATABASE DMCapabiliteRetest ADD FILE ( NAME = N''DMCapabiliteRetestFile@f_@fg'', FILENAME = N''d:\DATABASES\DMCapabiliteRetestFile@f_@fg.ndf'', SIZE = 3MB, FILEGROWTH = 1MB ) TO FILEGROUP [DMCapabiliteRetestFg@fg]'
